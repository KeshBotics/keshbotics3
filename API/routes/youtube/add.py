# Author: @Travis-Owens
# Date: 2020-10-17
# Description: This class is used to add YouTube notifiaction to the database.
...
class youtube_add(object):
    ...
    def on_get(self, req, resp):
        try:
            ...
            disc_guild_id    = req.get_header('discord-guild-id')
            ...
            message = youtube_management().subscribe(yt_channel_url, disc_guild_id, disc_channel_id)
